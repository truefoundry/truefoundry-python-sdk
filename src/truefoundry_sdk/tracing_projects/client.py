...
class AsyncTracingProjectsClient:
    ...
    async def create_or_update(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.tracing_projects.create_or_update(manifest=TracingProjectManifest(name='name', ), )
        asyncio.run(main())
        """
    ...
    async def get(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.tracing_projects.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EmptyResponse:
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.tracing_projects.delete(id='id', )
        asyncio.run(main())
        """
