...
class AsyncWorkspacesClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.workspaces.list(limit=10, offset=0, )
    ...
    async def create_or_update(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.workspaces.create_or_update(manifest=WorkspaceManifest(cluster_fqn='cluster_fqn', name='name', ), )
        asyncio.run(main())
        """
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetWorkspaceResponse:
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.workspaces.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.workspaces.delete(id='id', )
        asyncio.run(main())
        """
