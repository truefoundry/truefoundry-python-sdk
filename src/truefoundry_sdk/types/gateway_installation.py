...
class GatewayInstallation(UniversalBaseModel):
    id: str = pydantic.Field()
    """
    System-generated gateway installation ID.
    """

    service_account_id: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="serviceAccountId"), pydantic.Field(alias="serviceAccountId")
    ] = None
