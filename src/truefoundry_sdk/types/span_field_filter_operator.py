...
class SpanFieldFilterOperator(enum.StrEnum):
    ...
    def visit(
        ...
        if self is SpanFieldFilterOperator.EQUAL:
            return equal()
        if self is SpanFieldFilterOperator.NOT_EQUAL:
            return not_equal()
