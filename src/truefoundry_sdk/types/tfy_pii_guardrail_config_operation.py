...
class TfyPiiGuardrailConfigOperation(enum.StrEnum):
    """
    ...
    MUTATE = "mutate"
    VALIDATE = "validate"
    _UNKNOWN = "__TFYPIIGUARDRAILCONFIGOPERATION_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "TfyPiiGuardrailConfigOperation":
    ...
    def visit(
        ...
        if self is TfyPiiGuardrailConfigOperation.MUTATE:
            return mutate()
        if self is TfyPiiGuardrailConfigOperation.VALIDATE:
            return validate()
