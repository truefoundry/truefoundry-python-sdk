...
class VertexRegion(enum.StrEnum):
    GLOBAL = "global"
    ...
    EU = "eu"
    US = "us"
    _UNKNOWN = "__VERTEXREGION_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "VertexRegion":
    ...
    def visit(
        ...
        if self is VertexRegion.GLOBAL:
            return global_()
        if self is VertexRegion.AFRICA_SOUTH1:
            return africa_south1()
        if self is VertexRegion.ASIA_EAST1:
            return asia_east1()
        if self is VertexRegion.ASIA_EAST2:
            return asia_east2()
        if self is VertexRegion.ASIA_NORTHEAST1:
            return asia_northeast1()
        if self is VertexRegion.ASIA_NORTHEAST2:
            return asia_northeast2()
        if self is VertexRegion.ASIA_NORTHEAST3:
            return asia_northeast3()
        if self is VertexRegion.ASIA_SOUTH1:
            return asia_south1()
        if self is VertexRegion.ASIA_SOUTH2:
            return asia_south2()
        if self is VertexRegion.ASIA_SOUTHEAST1:
            return asia_southeast1()
        if self is VertexRegion.ASIA_SOUTHEAST2:
            return asia_southeast2()
        if self is VertexRegion.ASIA_SOUTHEAST3:
            return asia_southeast3()
        if self is VertexRegion.AUSTRALIA_SOUTHEAST1:
            return australia_southeast1()
        if self is VertexRegion.AUSTRALIA_SOUTHEAST2:
            return australia_southeast2()
        if self is VertexRegion.EUROPE_CENTRAL2:
            return europe_central2()
        if self is VertexRegion.EUROPE_NORTH1:
            return europe_north1()
        if self is VertexRegion.EUROPE_NORTH2:
            return europe_north2()
        if self is VertexRegion.EUROPE_SOUTHWEST1:
            return europe_southwest1()
        if self is VertexRegion.EUROPE_WEST1:
            return europe_west1()
        if self is VertexRegion.EUROPE_WEST2:
            return europe_west2()
        if self is VertexRegion.EUROPE_WEST3:
            return europe_west3()
        if self is VertexRegion.EUROPE_WEST4:
            return europe_west4()
        if self is VertexRegion.EUROPE_WEST6:
            return europe_west6()
        if self is VertexRegion.EUROPE_WEST8:
            return europe_west8()
        if self is VertexRegion.EUROPE_WEST9:
            return europe_west9()
        if self is VertexRegion.EUROPE_WEST10:
            return europe_west10()
        if self is VertexRegion.EUROPE_WEST12:
            return europe_west12()
        if self is VertexRegion.ME_CENTRAL1:
            return me_central1()
        if self is VertexRegion.ME_CENTRAL2:
            return me_central2()
        if self is VertexRegion.ME_WEST1:
            return me_west1()
        if self is VertexRegion.NORTHAMERICA_NORTHEAST1:
            return northamerica_northeast1()
        if self is VertexRegion.NORTHAMERICA_NORTHEAST2:
            return northamerica_northeast2()
        if self is VertexRegion.NORTHAMERICA_SOUTH1:
            return northamerica_south1()
        if self is VertexRegion.SOUTHAMERICA_EAST1:
            return southamerica_east1()
        if self is VertexRegion.SOUTHAMERICA_WEST1:
            return southamerica_west1()
        if self is VertexRegion.US_CENTRAL1:
            return us_central1()
        if self is VertexRegion.US_EAST1:
            return us_east1()
        if self is VertexRegion.US_EAST4:
            return us_east4()
        if self is VertexRegion.US_EAST5:
            return us_east5()
        if self is VertexRegion.US_SOUTH1:
            return us_south1()
        if self is VertexRegion.US_WEST1:
            return us_west1()
        if self is VertexRegion.US_WEST2:
            return us_west2()
        if self is VertexRegion.US_WEST3:
            return us_west3()
        if self is VertexRegion.US_WEST4:
            return us_west4()
        if self is VertexRegion.EU:
            return eu()
        if self is VertexRegion.US:
            return us()
