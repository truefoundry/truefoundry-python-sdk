...
class Policy(UniversalBaseModel):
    ...
    active_version: typing_extensions.Annotated[
        float, FieldMetadata(alias="activeVersion"), pydantic.Field(alias="activeVersion")
    ]
    active_policy_version: typing_extensions.Annotated[
        typing.Optional[PolicyVersion],
        FieldMetadata(alias="activePolicyVersion"),
        pydantic.Field(alias="activePolicyVersion"),
    ] = None
