...
class CalypsoAiGuardrailConfigOperation(enum.StrEnum):
    """
    ...
    VALIDATE = "validate"
    MUTATE = "mutate"
    _UNKNOWN = "__CALYPSOAIGUARDRAILCONFIGOPERATION_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "CalypsoAiGuardrailConfigOperation":
    ...
    def visit(
        ...
        if self is CalypsoAiGuardrailConfigOperation.VALIDATE:
            return validate()
        if self is CalypsoAiGuardrailConfigOperation.MUTATE:
            return mutate()
