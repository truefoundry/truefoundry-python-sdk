...
class GatewayRequestMetadataFilterOperator(enum.StrEnum):
    ...
    def visit(
        ...
        if self is GatewayRequestMetadataFilterOperator.EQUAL:
            return equal()
        if self is GatewayRequestMetadataFilterOperator.NOT_EQUAL:
            return not_equal()
        ...
        if self is GatewayRequestMetadataFilterOperator.PRESENT:
            return present()
        if self is GatewayRequestMetadataFilterOperator.IS_NULL:
            return is_null()
