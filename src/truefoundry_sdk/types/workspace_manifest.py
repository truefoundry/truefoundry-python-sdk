...
class WorkspaceManifest(UniversalBaseModel):
    ...
    collaborators: typing.Optional[typing.List[typing.Optional[typing.Any]]] = pydantic.Field(default=None)
    """
    +label=Collaborators
    +sort=500
    """

    permissions: typing.Optional[typing.List[typing.Optional[typing.Any]]] = pydantic.Field(default=None)
    """
    +label=Permissions
    +sort=500
    +uiType=Permissions
