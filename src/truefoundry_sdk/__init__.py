...
if typing.TYPE_CHECKING:
    ...
    from .agents import ListAgentsRequestType
    ...
    from .gateway_budgets import CreateOrUpdateBudgetRequestManifest, ListGatewayBudgetsRequestType
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "Agent": ".types",
    "AgentChannel": ".types",
    "AgentChannelAgent": ".types",
    "AgentChannelConfig": ".types",
    "AgentChannelManifest": ".types",
    "AgentChannelSlackAuth": ".types",
    "AgentChannelSlackBotTokenAuth": ".types",
    "AgentChannelSlackConfig": ".types",
    ...
    "BudgetAlert": ".types",
    "BudgetConfig": ".types",
    "BudgetEntityUsage": ".types",
    "BudgetLimitUnit": ".types",
    "BudgetRule": ".types",
    "BudgetUsageEntry": ".types",
    "BudgetUsageEntryMode": ".types",
    "BudgetUsageEntryType": ".types",
    "BudgetUsageResponse": ".types",
    "BudgetV2Alert": ".types",
    ...
    "BuildInfo": ".types",
    "BuildSecret": ".types",
    "CalypsoAiApiKeyAuth": ".types",
    "CalypsoAiGuardrailConfig": ".types",
    "CalypsoAiGuardrailConfigConfig": ".types",
    "CalypsoAiGuardrailConfigOperation": ".types",
    "Canary": ".types",
    "CanaryStep": ".types",
    "CancelDeploymentApplicationsResponse": ".applications",
    ...
    "ComplexityBasedLoadBalanceTarget": ".types",
    "ComplexityBasedLoadBalanceTargetTier": ".types",
    "ComplexityBasedLoadBalancing": ".types",
    "ComplexityBasedLoadBalancingClassificationStrategy": ".types",
    "Config": ".types",
    ...
    "CreateOrUpdateBudgetRequestManifest": ".gateway_budgets",
    ...
    "CustomServerAwsAccessKeyAuth": ".types",
    "CustomServerAwsAssumeRoleAuth": ".types",
    "CustomServerAwsSigV4": ".types",
    "CustomServerAwsSigV4Auth": ".types",
    "CustomServerHeaderAuth": ".types",
    "CustomServerOAuth2Marker": ".types",
    "CustomServerOAuth2MarkerGrantType": ".types",
    ...
    "GcpGkeIntegrationLocation": ".types",
    "GcpGsm": ".types",
    ...
    "HelmRepo": ".types",
    "HelmSource": ".types",
    "HeuristicClassificationStrategy": ".types",
    "HeuristicFallbackStrategy": ".types",
    ...
    "ListAgentsRequestType": ".agents",
    "ListAgentsResponse": ".types",
    "ListApplicationDeploymentsResponse": ".types",
    "ListApplicationsRequestDeviceTypeFilter": ".applications",
    "ListApplicationsRequestLifecycleStage": ".applications",
    "ListApplicationsResponse": ".types",
    "ListArtifactVersionsResponse": ".types",
    "ListArtifactsResponse": ".types",
    "ListBudgetsResponse": ".types",
    ...
    "ListGatewayBudgetsRequestType": ".gateway_budgets",
    ...
    "LlmClassificationStrategy": ".types",
    "LlmClassificationStrategyFallbackStrategy": ".types",
    ...
    "McpServer": ".types",
    "McpServerAuth": ".types",
    "McpServerAuthStatusInfo": ".types",
    "McpServerAuthStatusInfoMethod": ".types",
    "McpServerAuthStatusInfoStatus": ".types",
    "McpServerAwsAccessKeyAuth": ".types",
    "McpServerAwsAssumeRoleAuth": ".types",
    "McpServerAwsSigV4Auth": ".types",
    "McpServerAwsSigV4AuthAuth": ".types",
    ...
    "McpServerOAuth2ClientAuthentication": ".types",
    "McpServerOAuth2GrantType": ".types",
    "McpServerOAuth2JwtSource": ".types",
    "McpServerOAuth2Provider": ".types",
    "McpServerOAuth2ProviderAuth0Settings": ".types",
    "McpServerOAuth2ProviderOktaIdJagSettings": ".types",
    "McpServerOAuth2ProviderOktaSettings": ".types",
    ...
    "MicrosoftFoundryModel": ".types",
    "MicrosoftFoundryModelDeploymentType": ".types",
    "MicrosoftFoundryModelPublisher": ".types",
    "MicrosoftFoundryProviderAccount": ".types",
    "MicrosoftFoundryProviderAccountAuthData": ".types",
    "MimeType": ".types",
    "MirrorAction": ".types",
    ...
    "NomaSecurityApiKeyAuth": ".types",
    "NomaSecurityGuardrailConfig": ".types",
    "NomaSecurityGuardrailConfigConfig": ".types",
    "NomaSecurityGuardrailConfigOperation": ".types",
    ...
    "OtelMetricsExporterCommonConfig": ".types",
    ...
    "PeriodUsage": ".types",
    "PermissionSetV2": ".types",
    "PermissionSetV2ResourceType": ".types",
    "Permissions": ".types",
    ...
    "PromptSource": ".types",
    "PromptVersion": ".types",
    "ProviderAccount": ".types",
    "ProviderAccountProvider": ".types",
    "ProviderAccounts": ".types",
    "ProviderIntegration": ".types",
    "ProviderIntegrationType": ".types",
    "PublicCostMetric": ".types",
    "PySparkTaskConfig": ".types",
    "PySparkTaskConfigImage": ".types",
    ...
    "SecretStoreIntegrationConfig": ".types",
    "SecretVersion": ".types",
    ...
    "SparkJob": ".types",
    "SparkJobDriverConfig": ".types",
    "SparkJobEntrypoint": ".types",
    "SparkJobExecutorConfig": ".types",
    "SparkJobImage": ".types",
    ...
    "StaticFallbackStrategy": ".types",
    "StaticFallbackStrategyDefaultTier": ".types",
    ...
    "TeamVirtualAccountDataAccessRule": ".types",
    ...
    "TrueFoundryAgentGitSourceSkill": ".types",
    "TrueFoundryAgentLargeToolResponseConfig": ".types",
    "TrueFoundryAgentManifest": ".types",
    "TrueFoundryAgentMcpServer": ".types",
    "TrueFoundryAgentMcpServerInline": ".types",
    "TrueFoundryAgentMcpServerRegistry": ".types",
    "TrueFoundryAgentModel": ".types",
    "TrueFoundryAgentModelParams": ".types",
    "TrueFoundryAgentResponseFormat": ".types",
    "TrueFoundryAgentSandboxAuthData": ".types",
    "TrueFoundryAgentSandboxAuthInject": ".types",
    "TrueFoundryAgentSandboxAuthInjectMatch": ".types",
    "TrueFoundryAgentSandboxBasicAuthData": ".types",
    "TrueFoundryAgentSandboxConfig": ".types",
    "TrueFoundryAgentSandboxGitAuthInject": ".types",
    "TrueFoundryAgentSandboxNetworkPolicy": ".types",
    "TrueFoundryAgentSkill": ".types",
    "TrueFoundryAgentTrueFoundrySkill": ".types",
    ...
    "TrueFoundryApplyResponseData": ".types",
