...
from truefoundry_sdk.v1._wrapped_clients import WrappedPromptVersionsClient
...
class TrueFoundry(BaseTrueFoundry):
    def __init__(
        ...
        *,
        ...
        self.v1.prompt_versions = WrappedPromptVersionsClient(client_wrapper=self.v1._client_wrapper)
