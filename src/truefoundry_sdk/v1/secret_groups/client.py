...
class AsyncSecretGroupsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v1.secret_groups.list(limit=10, offset=0, )
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.secret_groups.create(name='name', integration_id='integrationId', secrets=[SecretInput(key='key', value='value', )], )
        asyncio.run(main())
        """
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetSecretGroupResponse:
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.secret_groups.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.secret_groups.update(id='id', secrets=[UpdateSecretInput(key='key', value='value', )], )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.secret_groups.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def list_secrets(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.secret_groups.list_secrets(id='id', )
        asyncio.run(main())
        """
