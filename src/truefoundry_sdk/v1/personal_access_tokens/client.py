...
class AsyncPersonalAccessTokensClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v1.personal_access_tokens.list(limit=10, offset=0, )
    ...
    async def create(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.personal_access_tokens.create(name='name', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.personal_access_tokens.delete(id='id', )
        asyncio.run(main())
        """
