...
class AsyncAgentsClient:
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetAgentResponse:
        ...
        async def main() -> None:
            await client.v1.agents.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EmptyResponse:
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.agents.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def create_or_update(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.agents.create_or_update(manifest=ModelManifest(name='name', metadata={'key': 'value'
            }, ml_repo='ml_repo', source=TrueFoundryManagedSource(), ), )
        asyncio.run(main())
        """
