...
class AsyncDeploymentsClient:
    ...
    async def get_builds(
        ...
        async def main() -> None:
            await client.v1.internal.deployments.get_builds(
                id="id",
                deployment_id="deploymentId",
            )
    ...
    async def get_code_upload_url(
        ...
        async def main() -> None:
            await client.v1.internal.deployments.get_code_upload_url(
                service_name="serviceName",
                workspace_fqn="workspaceFqn",
            )
    ...
    async def get_suggested_endpoint(
        ...
        *,
        ...
        async def main() -> None:
            await client.v1.internal.deployments.get_suggested_endpoint(
                application_type=ApplicationType.ASYNC_SERVICE,
                application_name="applicationName",
                workspace_id="workspaceId",
            )
