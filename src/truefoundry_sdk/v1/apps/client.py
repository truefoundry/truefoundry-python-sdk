...
from ...types.get_applications_response import GetApplicationsResponse
...
class AppsClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetApplicationsResponse,  # type: ignore
    ...
    def get_deployment_builds(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/svc/v1/apps/{jsonable_encoder(application_id)}/deployments/{jsonable_encoder(deployment_id)}/builds",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncAppsClient:
    ...
    async def get_deployment_builds(
        ...
        *,
        ...
        async def main() -> None:
            await client.v1.apps.get_deployment_builds(
                application_id="applicationId",
                deployment_id="deploymentId",
            )
