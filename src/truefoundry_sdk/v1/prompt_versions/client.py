...
from .raw_client import RawPromptVersionsClient
import typing
...
from .raw_client import AsyncRawPromptVersionsClient
...
class AsyncPromptVersionsClient:
    ...
    async def get(
        ...
        async def main() -> None:
            await client.v1.prompt_versions.get(
                id="id",
            )
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EmptyResponse:
        ...
        async def main() -> None:
            await client.v1.prompt_versions.delete(
                id="id",
            )
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v1.prompt_versions.list()
