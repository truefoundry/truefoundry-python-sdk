...
from .raw_client import RawAgentVersionsClient
import typing
...
from .raw_client import AsyncRawAgentVersionsClient
...
class AgentVersionsClient:
    ...
    def resolve(self, *, fqn: str, request_options: typing.Optional[RequestOptions] = None) -> ResolveAgentAppResponse:
        ...
        """
        response = self._raw_client.resolve(fqn=fqn, request_options=request_options)
...
class AsyncAgentVersionsClient:
    ...
    async def resolve(
        ...
        asyncio.run(main())
        """
        response = await self._raw_client.resolve(fqn=fqn, request_options=request_options)
        return response.data
