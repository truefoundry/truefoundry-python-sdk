...
class RawArtifactVersionsClient:
    ...
    ) -> HttpResponse[SyncPager[ArtifactVersion]]:
        """
    ...
    def list_files(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[SyncPager[FileInfo]]:
        """
        Parameters
        ----------
        id : str
...
class AsyncRawArtifactVersionsClient:
    ...
    async def list(
        ...
        *,
        ...
        include_internal_metadata: typing.Optional[bool] = False,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AsyncPager[ArtifactVersion]]:
        """
        List artifact version API
    ...
    async def list_files(
        ...
        *,
        ...
        page_token: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AsyncPager[FileInfo]]:
        """
        Parameters
        ----------
        id : str
