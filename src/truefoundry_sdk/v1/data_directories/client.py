...
class AsyncDataDirectoriesClient:
    ...
    async def get(
        ...
        async def main() -> None:
            await client.v1.data_directories.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.data_directories.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def create_or_update(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.data_directories.create_or_update(manifest=ModelManifest(name='name', metadata={'key': 'value'
            }, ml_repo='ml_repo', source=TrueFoundryManagedSource(), ), )
        asyncio.run(main())
        """
    ...
    async def list_files(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            response = await client.v1.data_directories.list_files(id='id', )
            async for item in response:
                yield item
    ...
    async def delete_files(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.data_directories.delete_files(id='id', paths=['paths'], )
        asyncio.run(main())
        """
    ...
    async def get_signed_urls(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.data_directories.get_signed_urls(id='id', paths=['paths'], operation=Operation.READ, )
        asyncio.run(main())
        """
    ...
    async def create_multipart_upload(
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.v1.data_directories.create_multipart_upload(id='id', path='path', num_parts=1, )
        asyncio.run(main())
        """
