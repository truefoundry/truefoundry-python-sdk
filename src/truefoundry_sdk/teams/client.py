...
class AsyncTeamsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.teams.list(limit=10, offset=0, )
    ...
    async def create_or_update(
        ...
        *,
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.teams.create_or_update(manifest=TeamManifest(name='name', members=['members'], ), )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DeleteTeamResponse:
        ...
        client = AsyncTrueFoundry(api_key="YOUR_API_KEY", base_url="https://yourhost.com/path/to/api", )
        async def main() -> None:
            await client.teams.delete(id='id', )
        asyncio.run(main())
        """
